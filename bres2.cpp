...
// Program - 5
// Program : Draw two parallel lines by using Bresenham’s line drawing algorithm
// when two points are given for the first line, and for the second line, only the
// y value is changed by a natural number 'n'.
